...
If you wish to or are required to provided a version for your portal or construct your own document, this is still possible. You may use the same endpoint as above with the accept heaader set to application/json.
