...
Simply send a POST request to the above endpoints with any or no response body. The expected response for success is 204 No Content with no request body.
