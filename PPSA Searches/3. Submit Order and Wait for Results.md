...
See the values file for a table of typical completion times for these order types. Once the order is in the status "Complete" you may cease polling and retreive results for the order.
